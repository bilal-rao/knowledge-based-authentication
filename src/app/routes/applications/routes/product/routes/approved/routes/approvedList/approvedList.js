...
import ApplicationAdd from "@material-ui/icons/PlaylistAdd";
...
class DataTable extends React.Component {
  ...
  componentDidMount() {
    ...
    let proCode = location.split("/").reverse()[1];
  ...
  componentDidUpdate() {
    if (this.props.deleteGroupSuccess) {
      if (this.props.isMakerCheckerEnabled) {
        ...
        this.props.history.push("/app/applications/personal-loan/pending");
      } else {
        NotificationManager.success("Application has been deleted!");
      }
    }
  ...
  onHandleClick = (mode, id) => {
    ...
    this.props.history.push(
      `/app/applications/personal-loan/approved/${mode}/${id}`
    );
  };
  ...
  render() {
    ...
    return (
      <Paper>
        <Toolbar>
          <div className="title">
            <Typography type="title">{`${localStorage.getItem("proName")} Listing`}</Typography>
          </div>
            ...
            <IconButton
              ...
              onClick={() =>
                this.props.history.push(
                  ...
                  }/add/step1/initialize-application`
                )
              }
            >
                        ...
                        <TableCell>
                          <div style={{ display: "inline-flex" }}>
                            ...
                            <IconButton
                              ...
                              aria-label="Delete"
                              onClick={() => {
                                this.deleteApplication(n.groupId);
                              }}
                            >
