...
const countryListOptions = [
  {name: 'Pakistan', flagCode: 'pk', badge: '92', badgeColor: 'green'},
  {name: 'United State', flagCode: 'us', badge: '27', badgeColor: 'primary'},
  {name: 'France', flagCode: 'fr', badge: '32', badgeColor: 'teal'},
  {name: 'Germany', flagCode: 'gm', badge: '18', badgeColor: 'purple'},
  {name: 'Spain', flagCode: 'es', badge: '30', badgeColor: 'cyan'},
...
class CountrySelect extends React.Component {
  state = {
    countryList: this.props.value ? this.props.value : null
  };

  handleChangeSingle = countryList => {
    this.props.country(countryList.value);
    this.setState({
      countryList
    });
  };
  ...
  constructor(props) {
    super(props);
    props.country(this.state.countryList);
  }
  // code end
