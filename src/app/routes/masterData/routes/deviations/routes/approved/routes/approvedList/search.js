...
import { showDeviationLoader, searchDeviation, fetchDeviation } from "actions/Deviation";
...
class Search extends Component {
  ...
  onSubmit = () => {
    ...
    this.props.searchDeviation({
      byName: this.state.name,
      byCode: this.state.code
    });
  };
  ...
  render() {
    return (
      <Dialog
        ...
        maxWidth="md"
      >
        <DialogTitle>Search Deviation</DialogTitle>
        <DialogContent>
          <form className="row">
