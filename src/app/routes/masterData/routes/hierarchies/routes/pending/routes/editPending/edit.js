...
class Edit extends React.Component {
  ...
  componentWillMount() {
    if (this.props.getIndividualRecord && this.props.getIndividualRecord.name) {
      this.props.getHierarchyTypesName();
      if (this.props.getIndividualRecord.type) {
        if (this.props.getIndividualRecord.type === 0) {
          this.setState({
            type: "area"
          });
        } else if (this.props.getIndividualRecord.type === 1) {
          this.setState({
            type: "branch"
          });
        } else if (this.props.getIndividualRecord.type === "city") {
          this.this.props.getHierarchyTypesName(2);
          this.setState({
            type: "city"
          });
        } else if (this.props.getIndividualRecord.type === "province") {
          this.this.props.getHierarchyTypesName(3);
          this.setState({
            type: "province"
          });
        } else if (this.props.getIndividualRecord.type === "zone") {
          this.this.props.getHierarchyTypesName(4);
          this.setState({
            type: "zone"
          });
        } else {
      ...
      this.setState({
        ...
        type: this.props.getIndividualRecord.type,
        ...
        hierarchyId: this.props.getIndividualRecord.hierarchyId,
        acronym: acronym
      });
    }
  }
  ...
  handleSubmit = e => {
    ...
    if (this.state.error.email) {
      ...
      const obj = {
        ...
        parentId: this.state.nameOfType
      };
  ...
  handleTypeValue = type => {
    if (type === "area") {
      this.props.getHierarchyTypesName(0);
      this.setState({
        type
      });
    } else if (type === "branch") {
      this.props.getHierarchyTypesName(1);
      this.setState({
        type
      });
    } else if (type === "city") {
      this.props.getHierarchyTypesName(2);
      this.setState({
        type
      });
    } else if (type === "province") {
      this.props.getHierarchyTypesName(3);
      this.setState({
        type
      });
    } else if (type === "zone") {
      this.props.getHierarchyTypesName(4);
      this.setState({
        type
      });
    } else {
  ...
  handleNameValue = nameOfType => {
    this.setState({
      nameOfType
    });
  };
  hierarchyType = hierarchyType => {
    if (hierarchyType === "area") {
      this.setState({
        hierarchyType,
        typeEnum: 0
      });
    } else if (hierarchyType === "branch") {
      this.setState({
        hierarchyType,
        typeEnum: 1
      });
    } else if (hierarchyType === "city") {
      this.setState({
        hierarchyType,
        typeEnum: 2
      });
    } else if (hierarchyType === "province") {
      this.setState({
        hierarchyType,
        typeEnum: 3
      });
                ...
                <div className="col-md-6 col-12" style={{ marginTop: "30px" }}>
                  <Input name=""
                    ...
                    inputProps={{
                      classes,
                      value: type,
                      // value: type === 0 ? this.setState({type: 'area'}) : type === 1 ? this.setState({type: 'branch'}) : type === 2 ? this.setState({type: 'city'}) : type === 3 ? this.setState({type: 'province'}) : type === 4 ? this.setState({type: 'zone'}) : '',
                      // value: type === 0 ? 'area' : type === 1 ? 'branch' : type === 2 ? 'city' : type === 3 ? 'province' : type === 4 ? 'zone' : '',
                ...
                <div className="col-md-6 col-12" style={{ marginTop: "30px" }}>
                  <Input name=""
                    ...
                    inputProps={{
                      ...
                      name: "react-select-single",
                      simpleValue: true,
                      options: this.props.hierarchyType
                        ? this.props.hierarchyType.map(suggestion => ({
                          value: suggestion.hierarchyId,
                ...
                >
                  <div className="jr-btn-group">
                    ...
                    <Button name=""
                      ...
                      onClick={() => this.props.data.history.push('/app/masterdata-management/hierarchies/pending')}
                    >
...
function mapStateToProps(state) {
  return {
    hierarchyType: state.hierarchiesData.getHierarchyTypesName
      ? state.hierarchiesData.getHierarchyTypesName.data.items
      : "",
    getIndividualRecord: state.hierarchiesData.individualHierarchyData.data,
