...
class DataTable extends React.Component {
  ...
  componentDidUpdate() {
    ...
    if (this.props.individualHierarchyData) {
      if (this.props.individualHierarchyData.data.page === 'view') {
        this.props.history.push('/app/masterdata-management/hierarchies/pending/view/' + this.props.individualHierarchyData.data.id);
      }
      else {
        this.props.history.push('/app/masterdata-management/hierarchies/pending/edit/' + this.props.individualHierarchyData.data.id);
      }
    }
            ...
            {this.props.mainLoader === false && this.props.hierarchyList ? (
              <Table className="">
                    ...
                    .map(n => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell>
                            {n.type === "Branch" ? (
                              <Badge color="secondary">Branch</Badge>
                            ) : n.type === "City" ? (
                              <Badge color="info">City</Badge>
                            ) : n.type === "Province" ? (
                              <Badge color="primary">Province</Badge>
                            ) : (
                                    (n.type === "Area" ? (
                                      <Badge color="warning">Area</Badge>
                                    ) : (
                                        <Badge color="danger">Zone</Badge>
                                      ))
                                  )}
                          </TableCell>
                          <TableCell>
                ...
                <TableFooter>
                  <TableRow>
                    <TablePagination
                      count={this.props.hierarchyList.length}
